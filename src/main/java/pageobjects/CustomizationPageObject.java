...
public class CustomizationPageObject
{
    ...
    @FindBy(xpath = "/html/body/ev-root/ev-base-layout/ev-house-order-page/div/ev-step-customize-order/div/div/div/ev-products-ordering-list/ev-product-ordering[2]/div/div[1]/ev-number-selector/div/button[2]")
